  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={box}>
          <Img
            src={getMediaUrl("/stripe-logo.png")}
            width="49"
            height="21"
            alt="Stripe"
          />
          ...
          <Text style={paragraph}>
            ...
            You can find answers to most questions and get in touch with
            us on our{" "}
...
const box = createStyles({
  padding: "0 48px",
});

const hr = createStyles({
  borderColor: "#e6ebf1",
  margin: "20px 0",
});
